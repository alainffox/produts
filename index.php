    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 ">
            <div class="service-box">
                <div class="service-icon purpe">
                    <div class="front-content">
                        <i class="fa fa-map-marker"></i>
                        <h3><strong>Sismos Perú</strong></h3>
                        <h5>Información del ultimo sismo en Perú y los sismos percibidos.</h5>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-6 ">
            <div class="service-box">
                <div class="service-icon lead-light">
                    <div class="front-content">
